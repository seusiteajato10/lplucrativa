...
const Index = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white dark:from-slate-900 dark:to-slate-800">
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-20">
            ...
            <Link 
              ...
              className="inline-flex items-center gap-2 px-8 py-4 border-2 border-gray-200 dark:border-gray-700 text-gray-900 dark:text-gray-100 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl font-semibold hover:bg-gray-50 dark:hover:bg-gray-700/50 hover:border-gray-300 dark:hover:border-gray-600 transition-all duration-300 text-lg shadow-xl hover:shadow-gray-200/50"
            >
      ...
      {/* RESTO DA LANDING (features, pricing, etc.) */}
      <section className="py-24 px-4">
        <div className="max-w-7xl mx-auto">
          {/* Suas seções existentes continuam aqui */}
          <div className="text-center">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Pronto para começar?</h2>
            <p className="text-xl text-gray-600 mb-12">Crie sua primeira landing page em menos de 2 minutos.</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link to="/templates/galeria" className="border-2 border-gray-200 text-gray-900 px-12 py-6 rounded-3xl font-bold text-xl hover:bg-gray-50 transition-all shadow-xl hover:shadow-gray-200/50">
                Ver Templates
              </Link>
            </div>
          </div>
