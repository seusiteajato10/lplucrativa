...
export default function ProductTemplate({ data, projectName }: ProductTemplateProps) {
  ...
  // Merge dos dados recebidos com os padrões para evitar erros de undefined
  const templateData: TemplateData = { ...defaultTemplateData, ...data };
  
  // Prioriza Headline/ProjectName e campos editáveis
  ...
  return (
    <div className="min-h-screen bg-gray-50" style={{ fontFamily: templateData.styles.fontFamily }}>
      ...
      <div className="container mx-auto px-4 py-6 md:py-10 max-w-6xl">
            ...
            <div>
              ...
              <div className="mb-6">
                ...
                <p className="text-gray-600">
                  em até <strong>12x de R$ {(price / 12).toFixed(2)}</strong> sem juros
                </p>
              </div>
              ...
              <Button 
                className="w-full text-white font-bold text-xl py-8 rounded-lg mb-3 hover:opacity-90 transition-opacity"
        ...
        {templateData.productBenefits && templateData.productBenefits.length > 0 && (
          <div className="bg-white rounded-lg shadow-lg p-6 mb-6 text-left">
            ...
            <div className="grid md:grid-cols-2 gap-3">
              {templateData.productBenefits.map((benefit, idx) => (
                <div key={idx} className="flex items-center gap-2 text-gray-700">
                  <div className="w-2 h-2 rounded-full" style={{ backgroundColor: templateData.styles.primaryColor }}></div>
                  <span>{benefit}</span>
                </div>
              ))}
            </div>
        ...
        {/* Garantia Dinâmica */}
        <div className="bg-white rounded-lg shadow-lg p-6 text-center border-2 border-dashed border-gray-200">
