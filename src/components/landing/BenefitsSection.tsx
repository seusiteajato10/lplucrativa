...
const BenefitsSection = ({ featuresContent }: BenefitsSectionProps) => {
  ...
  const items = featuresContent?.items && featuresContent.items.length > 0 ? featuresContent.items : defaultBenefits;
...
{defaultBenefits[index]?.icon && (() => {
  const Icon = defaultBenefits[index].icon;
